...
## Type: Dict
# c.aliases = {'q': 'quit', 'wq': 'quit --save', 'w': 'session-save'}
...
## Type: Dict
# c.bindings.key_mappings = {'<Ctrl-[>': '<Escape>', '<Ctrl-6>': '<Ctrl-^>', '<Shift-Enter>': '<Return>', '<Ctrl-M>': '<Return>', '<Ctrl-Enter>': '<Ctrl-Return>', '<Ctrl-J>': '<Return>', '<Shift-Return>': '<Return>', '<Enter>': '<Return>'}
...
## Type: Padding
# c.statusbar.padding = {'bottom': 1, 'top': 1, 'right': 0, 'left': 0}
...
## Type: Padding
# c.tabs.indicator_padding = {'bottom': 2, 'top': 2, 'right': 4, 'left': 0}
...
## Type: Padding
# c.tabs.padding = {'bottom': 0, 'top': 0, 'right': 5, 'left': 5}
